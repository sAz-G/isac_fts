...
params = struct('sim', ...
                ...
                'energy', ...
                 ...
                 'opt_settings', ...
                            ...
                            'precision'             , {'best'},            ... % higher not necassarily better
                            'threshold'             , {1e-03},            ...  % lower might be worse. try out to find best.
                            'screen_out'            , {1},                ...  % screen output     
