...
%
% USAGE: 
% Define parameters before running the algorithm in multi_stage_script.
% To run Monte Carlo simulations, navigate to src/main_algorithm/monte_carlo
% and run one of the var_* files provided.
%
%------------------------------------------------------------------------
...
% Additional parameters dependent on other parameters
